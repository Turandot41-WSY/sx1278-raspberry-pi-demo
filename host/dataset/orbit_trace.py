...
from host.dataset.orbit_record import pack_mission_record, unpack_mission_record
from host.dataset.payload_schedule import PayloadSample, PayloadSchedule
...
def _verify_generator_provenance(value: object) -> None:
    ...
    # Project decision: docs/adr/0001-direct-experiment-workflow.md.
