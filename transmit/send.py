...
from transmit.inputs import prepare_transmit_inputs

from firmware.host.profile_truth import load_profile_truth
from firmware.host.runtime_config import PROJECT_ROOT, parse_configured_args
...
from transmit.radio import transmit_frame
...
def run(arguments=None, *, section="saved") -> int:
    ...
    radio_table_directory = PROJECT_ROOT / "firmware" / "config"
